...
from midisommar.cli_spec import REGISTRY, build_parser
from midisommar.core.device import resolve_device
from midisommar.core.event import Event, notes_to_events
from midisommar.core.vocab import EventCodec, Fields, VocabConfig
from midisommar.data.midi import augment, cross_pairs, load_midi_dir
from midisommar.model.checkpoint import (
    load_model as load_model,  # noqa: F401  (re-exported for callers/tests)
)
from midisommar.model.checkpoint import save_model
...
def conditional_main() -> None:
    ...
    if args.target_drums:
        from midisommar.data.drums import load_drum_kits
