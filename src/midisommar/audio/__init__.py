...
buffer (:mod:`midisommar.audio.yin`), segments the per-frame pitch into discrete notes
(:mod:`midisommar.audio.segment`), and feeds those into the same ``HumanStream`` the duet already
