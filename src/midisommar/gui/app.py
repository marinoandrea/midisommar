...
Every command in :data:`midisommar.cli_spec.REGISTRY` appears automatically — there is no
...
from midisommar.cli_spec import REGISTRY
...
from midisommar.gui.workers import CommandProcess
...
class MainWindow(QMainWindow):
    def __init__(self) -> None:
        super().__init__()
        self.setWindowTitle("midisommar control center")
