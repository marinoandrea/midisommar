...
seamlessly joined. Route a Live MIDI track's input at the port (``midisommar out``) with an
...
def stream(
    ...
    *,
    ...
    ``clock`` (see :mod:`midisommar.realtime.clock`) supplies the beat position: a ``WallClock`` for free-running
