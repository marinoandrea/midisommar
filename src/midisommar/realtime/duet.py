...
from midisommar.cli_spec import REGISTRY, build_parser  # noqa: E402
from midisommar.core.event import DEFAULT_STEPS_PER_BEAT  # noqa: E402
from midisommar.core.note import Note  # noqa: E402
from midisommar.core.vocab import EventCodec  # noqa: E402
from midisommar.data.pairs import interleave  # noqa: E402
from midisommar.data.snapshot import save_snapshot  # noqa: E402
from midisommar.model.checkpoint import load_model  # noqa: E402
from midisommar.osc.listen import OSCTrigger  # noqa: E402
from midisommar.realtime.clock import make_clock  # noqa: E402
from midisommar.realtime.partner import (  # noqa: E402,F401
    AudioPartnerInput,
    HumanStream,
    MidiPartnerInput,
)
from midisommar.realtime.scheduler import AnticipatoryBuffer, Scheduled  # noqa: E402

DEFAULT_IN_PORT = "midisommar in"
DEFAULT_OUT_PORT = "midisommar out"

# HumanStream is defined in midisommar.realtime.partner (so the audio input can share it without an
...
def duet(
    ...
    *,
    ...
    ``partner`` is the partner-note source (see :mod:`midisommar.realtime.partner`): a
    ...
    ``clock`` is the shared beat clock (see :mod:`midisommar.realtime.clock`): a ``WallClock`` for free-running
    ...
    # a training pair (see midisommar.data.snapshot). Triggers run on their own threads so they
