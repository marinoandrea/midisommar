...
# Mirrors midisommar.core.event.DEFAULT_STEPS_PER_BEAT (kept literal to avoid a heavy import here).
...
_DUET = Command(
    name="duet",
    entry="midisommar.realtime.duet:main",
...
_PLAY = Command(
    name="play",
    entry="midisommar.realtime.play:main",
...
_LIVE = Command(
    name="live",
    entry="midisommar.realtime.live:main",
...
_GENERATE = Command(
    name="generate",
    entry="midisommar.inference:main",
...
_TRAIN = Command(
    name="train",
    entry="midisommar.training.train:main",
...
_TRAIN_CONDITIONAL = Command(
    ...
    entry="midisommar.training.train:conditional_main",
...
_TRAIN_PAIRED = Command(
    name="train-paired",
    entry="midisommar.training.train:paired_main",
...
_BUILD_PAIRS = Command(
    name="build-pairs",
    entry="midisommar.data.pairs:main",
...
_FAKE_HUMAN = Command(
    name="fake-human",
    entry="midisommar.realtime.fake_human:main",
...
_RECORD = Command(
    name="record",
    entry="midisommar.data.record:main",
...
_AUDIO_DEVICES = Command(
    name="audio-devices",
    entry="midisommar.audio.capture:main",
...
_AUDIO_TRACK = Command(
    name="audio-track",
    entry="midisommar.audio.track:main",
